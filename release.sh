...
echo "*** v${VERSION} of emberfire published to Bower ***"
echo
...
echo "*** Debug and non-debug versions of EmberFire copied to firebase-clients ***"
echo

# Overwrite the existing changelog
cp CHANGELOG.md $STANDALONE_DEST/changelog.txt

echo "*** EmberFire changelog copied to firebase-clients ***"
echo
